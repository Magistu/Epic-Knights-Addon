...
public class MilaneseArmetModel
{
	public static LayerDefinition createLayer()
	{
		...
		PartDefinition rmask_r3 = rmask.addOrReplaceChild("rmask_r3", CubeListBuilder.create().texOffs(0, 0).mirror().addBox(-5.26F, -5.2094F, -0.7901F, 6.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.2524F, -27.5406F, -5.9887F, -0.5163F, 0.2897F, -0.0894F));

		PartDefinition lmask = mask.addOrReplaceChild("lmask", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition lmask_r1 = lmask.addOrReplaceChild("lmask_r1", CubeListBuilder.create().texOffs(0, 28).mirror().addBox(-2.5F, -4.0F, 0.0F, 6.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-3.0067F, -27.5406F, -6.6144F, -1.1496F, 0.4648F, 0.0F));

		PartDefinition lmask_r2 = lmask.addOrReplaceChild("lmask_r2", CubeListBuilder.create().texOffs(0, 5).mirror().addBox(-5.45F, -3.4665F, 1.2716F, 6.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.1F, -24.0F, -7.0F, 0.6393F, 0.4648F, 0.0F));

		PartDefinition lmask_r3 = lmask.addOrReplaceChild("lmask_r3", CubeListBuilder.create().texOffs(0, 28).addBox(-3.5F, -4.0F, 0.0F, 6.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.0067F, -27.5406F, -6.6144F, -1.1496F, -0.4648F, 0.0F));

		PartDefinition lmask_r4 = lmask.addOrReplaceChild("lmask_r4", CubeListBuilder.create().texOffs(0, 5).addBox(-0.55F, -3.4665F, 1.2716F, 6.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.1F, -24.0F, -7.0F, 0.6393F, -0.4648F, 0.0F));

		PartDefinition lmask_r5 = lmask.addOrReplaceChild("lmask_r5", CubeListBuilder.create().texOffs(0, 0).addBox(-0.0142F, -5.2449F, 0.15F, 6.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.1F, -28.0F, -7.0F, -0.5165F, -0.3335F, 0.0896F));
