...
public class BurgundianKettlehatModel
{
	public static LayerDefinition createLayer() {
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -7.95F, -3.1F, 8.0F, 8.0F, 7.0F, new CubeDeformation(0.8F))
				.texOffs(6, 6).addBox(-4.0F, -7.9F, -3.9F, 8.0F, 8.0F, 1.0F, new CubeDeformation(0.77F)), PartPose.offset(0.0F, 0.0F, 0.0F));
