...
public class ClosedBurgonetModel
{
	public static LayerDefinition createLayer() {
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 10).addBox(0.0F, -13.4F, -5.2F, 0.0F, 9.0F, 13.0F, new CubeDeformation(0.0F))
				.texOffs(0, 0).addBox(-4.0F, -7.85F, -3.2F, 8.0F, 7.0F, 7.0F, new CubeDeformation(0.9F))
				.texOffs(6, 6).addBox(-4.0F, -7.85F, -3.7F, 8.0F, 7.0F, 1.0F, new CubeDeformation(0.87F)), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition cube_r1 = head.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(12, 16).addBox(-1.0F, -7.0F, -9.0F, 5.0F, 0.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -1.3F, 2.0F, 0.2597F, -0.0338F, 0.1265F));

		PartDefinition cube_r2 = head.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(2, 16).addBox(-4.1F, -7.0F, -9.0F, 5.0F, 0.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -1.3F, 2.0F, 0.2597F, 0.0338F, -0.1265F));
		...
		PartDefinition cube_r5 = head.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(39, 0).addBox(-5.1F, -3.2F, 4.2F, 10.0F, 1.0F, 2.0F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(0.0F, 1.0F, -0.3F, -0.2618F, 0.0F, 0.0F));
