...
public class OpenedSalletModel
{
	public static LayerDefinition createLayer()
	{
		...
		PartDefinition Helmet_r2 = head.addOrReplaceChild("Helmet_r2", CubeListBuilder.create().texOffs(0, 10).addBox(-4.0002F, 1.8568F, -5.5616F, 8.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -7.2357F, -4.5832F, -1.789F, 0.5847F, 1.5708F));

		PartDefinition Helmet_r3 = head.addOrReplaceChild("Helmet_r3", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0002F, 1.8636F, -0.4078F, 8.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -7.2357F, -4.5832F, -1.3526F, 0.5847F, 1.5708F));
		...
		PartDefinition Helmet_r4 = bone.addOrReplaceChild("Helmet_r4", CubeListBuilder.create().texOffs(12, 6).mirror().addBox(-2.556F, -1.867F, 5.3301F, 8.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(4.0F, -6.2899F, -0.7688F, -1.5708F, -0.7156F, -1.5708F));

		PartDefinition Helmet_r5 = bone.addOrReplaceChild("Helmet_r5", CubeListBuilder.create().texOffs(12, 6).addBox(-5.444F, -1.867F, 5.3301F, 8.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.0F, -6.2899F, -0.7688F, -1.5708F, 0.7156F, 1.5708F));
