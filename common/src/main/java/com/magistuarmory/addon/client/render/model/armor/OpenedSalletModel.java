...
public class OpenedSalletModel
{
	public static LayerDefinition createLayer()
	{
		...
		PartDefinition Helmet_r3 = head.addOrReplaceChild("Helmet_r3", CubeListBuilder.create().texOffs(0, 22).addBox(-2.501F, -4.7F, -6.6F, 1.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.0F, 0.0F, 0.0F, -2.0071F, 0.2618F, 1.5708F));

		PartDefinition Helmet_r4 = head.addOrReplaceChild("Helmet_r4", CubeListBuilder.create().texOffs(0, 22).addBox(-2.5F, -6.4F, -3.01F, 1.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -1.1345F, 0.2618F, 1.5708F));

		PartDefinition bone = head.addOrReplaceChild("bone", CubeListBuilder.create(), PartPose.offsetAndRotation(0.9968F, -4.8453F, -4.7949F, -0.5236F, 0.0F, 0.0F));

		PartDefinition Helmet_r5 = bone.addOrReplaceChild("Helmet_r5", CubeListBuilder.create().texOffs(0, 10).addBox(-9.3F, 1.6F, 1.67F, 8.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(5.0032F, 2.8453F, 2.7949F, -1.789F, 0.1309F, 1.5708F));

		PartDefinition Helmet_r6 = bone.addOrReplaceChild("Helmet_r6", CubeListBuilder.create().texOffs(0, 0).addBox(-9.3F, 2.9F, -1.806F, 8.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.9968F, 2.8453F, 2.7949F, -1.3526F, 0.1309F, 1.5708F));
