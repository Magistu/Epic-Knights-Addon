...
public class PatricianTuherHelmetModel {
	...
	public static LayerDefinition createLayer() {
		...
		PartDefinition lmask_r1 = lmask.addOrReplaceChild("lmask_r1", CubeListBuilder.create().texOffs(0, 29).addBox(-0.0142F, 0.1048F, -0.2342F, 6.0F, 2.0F, 1.0F, new CubeDeformation(0.1F)), PartPose.offsetAndRotation(0.0F, -27.0F, -8.0F, 0.5293F, -0.5984F, -0.0743F));

		PartDefinition lmask_r2 = lmask.addOrReplaceChild("lmask_r2", CubeListBuilder.create().texOffs(0, 29).mirror().addBox(-5.9858F, 0.1048F, -0.2342F, 6.0F, 2.0F, 1.0F, new CubeDeformation(0.1F)).mirror(false), PartPose.offsetAndRotation(0.0F, -27.0F, -8.0F, 0.5505F, 0.5931F, 0.0863F));
