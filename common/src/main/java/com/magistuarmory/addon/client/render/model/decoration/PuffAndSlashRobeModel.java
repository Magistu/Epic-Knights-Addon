...
public class PuffAndSlashRobeModel {
	...
	public static LayerDefinition createLayer() {
		...
		PartDefinition cube_r1 = skirt1.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(8, 0).mirror().addBox(0.8119F, -2.1068F, -3.0F, 4.0F, 9.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-1.1893F, -11.1926F, 1.576F, -0.2793F, 0.7854F, -0.192F));
		...
		PartDefinition cube_r3 = skirt1.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(8, 0).mirror().addBox(0.8119F, -2.1068F, -3.0F, 4.0F, 9.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-2.1893F, -11.1926F, 1.576F, -0.377F, 1.0405F, -0.2264F));
		...
		PartDefinition cube_r7 = skirt1.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(8, 0).addBox(-4.8119F, -2.1068F, -3.0F, 4.0F, 9.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.1893F, -11.1926F, 1.576F, -0.377F, -1.0405F, 0.2264F));

		PartDefinition cube_r8 = skirt1.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(8, 0).addBox(-4.8119F, -2.1068F, -3.0F, 4.0F, 9.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.1893F, -11.1926F, 1.576F, -0.2793F, -0.7854F, 0.192F));
		...
		PartDefinition cube_r9 = skirt2.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(8, 14).mirror().addBox(0.8119F, -2.1068F, -3.0F, 4.0F, 9.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-1.1893F, -11.1926F, 1.576F, -0.2793F, 0.7854F, -0.192F));
		...
		PartDefinition cube_r11 = skirt2.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(8, 14).mirror().addBox(0.8119F, -2.1068F, -3.0F, 4.0F, 9.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-2.1893F, -11.1926F, 1.576F, -0.377F, 1.0405F, -0.2264F));
		...
		PartDefinition cube_r15 = skirt2.addOrReplaceChild("cube_r15", CubeListBuilder.create().texOffs(8, 14).addBox(-4.8119F, -2.1068F, -3.0F, 4.0F, 9.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.1893F, -11.1926F, 1.576F, -0.377F, -1.0405F, 0.2264F));

		PartDefinition cube_r16 = skirt2.addOrReplaceChild("cube_r16", CubeListBuilder.create().texOffs(8, 14).addBox(-4.8119F, -2.1068F, -3.0F, 4.0F, 9.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.1893F, -11.1926F, 1.576F, -0.2793F, -0.7854F, 0.192F));

		PartDefinition body2 = body.addOrReplaceChild("body2", CubeListBuilder.create().texOffs(40, 16).addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(1.1F)), PartPose.offset(0.0F, 1.0F, 0.0F));
		...
		PartDefinition right_arm = partdefinition.addOrReplaceChild("right_arm", CubeListBuilder.create().texOffs(10, 8).addBox(-3.0F, -2.0F, -2.0F, 3.0F, 5.0F, 4.0F, new CubeDeformation(0.8F))
				...
				.texOffs(24, 4).addBox(-3.0F, -2.0F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(1.1F)), PartPose.offset(-5.0F, 2.0F, 0.0F));
		...
		PartDefinition left_arm = partdefinition.addOrReplaceChild("left_arm", CubeListBuilder.create().texOffs(10, 8).mirror().addBox(0.0F, -2.0F, -2.0F, 3.0F, 5.0F, 4.0F, new CubeDeformation(0.8F)).mirror(false)
				.texOffs(24, 4).mirror().addBox(-1.0F, -2.0F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(1.1F)).mirror(false)
				.texOffs(40, 4).mirror().addBox(-1.0F, -2.0F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(1.5F)).mirror(false), PartPose.offset(5.0F, 2.0F, 0.0F));
