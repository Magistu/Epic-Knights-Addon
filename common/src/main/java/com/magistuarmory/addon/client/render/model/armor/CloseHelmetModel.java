...
public class CloseHelmetModel {
	...
	public static LayerDefinition createLayer() {
		...
		PartDefinition lmask_r1 = lmask.addOrReplaceChild("lmask_r1", CubeListBuilder.create().texOffs(0, 0).mirror().addBox(-5.9858F, -5.2449F, 0.15F, 6.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.125F, -27.825F, -7.0F, -0.4222F, 0.2955F, 0.0028F));

		PartDefinition lmask_r2 = lmask.addOrReplaceChild("lmask_r2", CubeListBuilder.create().texOffs(0, 5).mirror().addBox(-5.45F, -3.4665F, 1.0F, 6.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.025F, -25.0F, -7.0F, 0.552F, 0.4648F, 0.0F));

		PartDefinition lmask_r3 = lmask.addOrReplaceChild("lmask_r3", CubeListBuilder.create().texOffs(0, 5).addBox(-0.55F, -3.4665F, 1.0F, 6.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.025F, -25.0F, -7.0F, 0.552F, -0.4648F, 0.0F));

		PartDefinition lmask_r4 = lmask.addOrReplaceChild("lmask_r4", CubeListBuilder.create().texOffs(0, 0).addBox(-0.0142F, -5.2449F, 0.15F, 6.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.125F, -27.825F, -7.0F, -0.4222F, -0.2955F, -0.0028F));
